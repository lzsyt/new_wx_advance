...
public class CommonJSONUtil {
    ...
    public static HashMap toHashMap(Object object)
    {
        ...
        JSONObject jsonObject = CommonJSONUtil.toJSONObject(object);
                                  ...
                                  String detailName, Class<D> detailClass)
    {
        ...
        T mainEntity = CommonJSONUtil.toBean(jsonObject, mainClass);
        List<D> detailList = CommonJSONUtil.toList(jsonArray, detailClass);
                                       ...
                                       Class<D2> detailClass2)
    {
        ...
        T mainEntity = CommonJSONUtil.toBean(jsonObject, mainClass);
        List<D1> detailList1 = CommonJSONUtil.toList(jsonArray1, detailClass1);
        List<D2> detailList2 = CommonJSONUtil.toList(jsonArray2, detailClass2);
                                           ...
                                           Class<D3> detailClass3)
    {
        ...
        List<D1> detailList1 = CommonJSONUtil.toList(jsonArray1, detailClass1);
        List<D2> detailList2 = CommonJSONUtil.toList(jsonArray2, detailClass2);
        List<D3> detailList3 = CommonJSONUtil.toList(jsonArray3, detailClass3);
