...
import com.kzq.advance.domain.TPwBillDetail;
...
public class PwBillVo  {
	...
	private List<TPwBillDetail> tPwBillDetails;

	public List<TPwBillDetail> gettPwBillDetails() {

		return tPwBillDetails;
	}

	public void settPwBillDetails(List<TPwBillDetail> tPwBillDetails) {
		this.tPwBillDetails = tPwBillDetails;
	}
